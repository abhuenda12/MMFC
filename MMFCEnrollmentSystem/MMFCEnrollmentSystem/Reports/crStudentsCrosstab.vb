...
Public Class crStudentsCrosstab
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MMFCEnrollmentSystem.crStudentsCrosstab.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrStudentsCrosstab
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crStudentsCrosstab = New crStudentsCrosstab
        rpt.Site = Me.Site
        Return rpt
    End Function
