...
Public Class crTeacherLoad
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MMFCEnrollmentSystem.crTeacherLoad.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_pTeacherName() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcrTeacherLoad
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crTeacherLoad = New crTeacherLoad
        rpt.Site = Me.Site
        Return rpt
    End Function
