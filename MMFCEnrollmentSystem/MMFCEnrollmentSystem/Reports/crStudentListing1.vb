...
Public Class crStudentListing
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MMFCEnrollmentSystem.crStudentListing.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_STUDENT_TYPE() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcrStudentListing
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crStudentListing = New crStudentListing
        rpt.Site = Me.Site
        Return rpt
    End Function
