...
Public Class crReceiptsListing
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MMFCEnrollmentSystem.crReceiptsListing.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrReceiptsListing
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crReceiptsListing = New crReceiptsListing
        rpt.Site = Me.Site
        Return rpt
    End Function
